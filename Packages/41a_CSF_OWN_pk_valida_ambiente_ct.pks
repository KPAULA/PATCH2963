...
-- Redmine #76105  - Ajuste no WS - Emissão de CTe
-- Rotina Alterada - pkb_ler_ct_int_ws => Incluídos os dm_st_proc (5, 10, 11, 12, 13, 15, 16, 99) na verificação de retorno de erro (vn_qtde)
...
--                   entraram em contingência via Webservice e se o cancelamento foi tentado via portal seta o campo 
