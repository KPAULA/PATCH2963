...
------------------------------------------------------------------------------------------------------------------------------------------------------------------
--
-- Em 24/03/2021   - Wendel Albino - patchs 2.9.6-3/ 2.9.5-6/ 297
-- Redmine #77370  - Ajuste para adequar regra NT 2020.006 versão 1.20 - PLSQL parte 1
-- Rotina Alterada - PKB_VALIDA_NOTA_FISCAL -> alteracao da regra de validacao com base na publicação da V1.20 na NT2020.006 de 17/03/2021
--                 - retirada dm_ind_press = 1 da validacao do preenchimento do DM_IND_INTERMED 
--
...
-- Redmine #76421  - Validação indevida
-- Rotina Alterada - PKB_INTEGR_NOTA_FISCAL_FISCO - Incluida verificação na fase 12.2 o "DM_TIPO" da tabela NfInfor_ADIC deve ser 1 se
--                   tiver informações do documento de arrecadação referenciado (nota_fiscal_fisco).
--
...
-- Rotina Alterada    - Excluída a função FKG_CHECA_CHAVE_ENVIO_PENDENTE
--                    - PKB_CONS_NFE_TERC e pkb_rel_cons_nfe_dest => Alterada a chamada da função FKG_CHECA_CHAVE_ENVIO_PENDENTE
--                      a variável pk_csf_api_cons_sit.gt_row_csf_cons_sit.id passou a receber null pq já existe busca de sequence na rotina de insert
--                    - PKB_CONS_NFE_TERC => Criei um índice com os joins dos cursores e incluí dm_ind_emit no cursor c_nf_zero, deixado somente um cursor para o processo
--                      retirado o modelo 65 pq está sendo tratado na pk_csf_api_nfce 
--                    - Excluída a rotina pkb_relac_nfe_cons_sit e incluída na pk_csf_api_cons_sit
--                    - Excluída a função fkg_ck_nota_fiscal_mde_registr e fkg_checa_existe_chave e incluída na pk_csf_api_cons_sit, alterada as chamadas dela
-- Liberado na versão - Release_2.9.7, Patch_2.9.6.2 e Patch_2.9.5.5
--
...
-- Redmine #71247 - Alterações em tabelas definitivas
-- Rotina alterada - pkb_integr_nf_forma_pgto => Inclusão de novos dominios para o campo NF_FORMA_PGTO.DM_TP_PAG.
-- Redmine #71250 - Utilização de campos em Open Interface
-- Rotina alterada - PKB_INTEGR_NOTA_FISCAL_FF => Inclusão dos flexfields DM_IND_INTERMED e COD_PART_INTERMED.
--
