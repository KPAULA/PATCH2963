...
--                     (539 - Duplicidade de NF-e, com diferença na Chave de Acesso) das rotinas nos select(s) para o retorno ao
--                     ERP do cliente. Conforme entendimento nesta data esse codigo impossibilita a autorização do documento.
--
-- Em 23/02/2021   - Allan Magrini - 2.9.6-2 / 2.9.7
-- Redmine #76421  - Validação indevida
-- Rotina Alterada - pkb_ler_Nota_Fiscal_Fisco - Adicionada fase 7.1 para validação do dm_tipo e 
--                   Comentada a fase 9 que criava o log de erro.
--
...
-- Rotina Alterada    - pkb_ler_cons_chave_nfe => Incluida pk_csf_api_cons_sit.fkg_checa_existe_chave 
