...
-------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------
Prompt INI - Redmine #76740 Criação de padrão speedgov - 47
-------------------------------------------------------------------------------------------------------------------------------------------
  ...
  exception  
      when dup_val_on_index then 
          begin 
              ...
              --
           exception when others then 
                raise_application_error(-20101, 'Erro no script Redmine #76740 Adicionar Padrão para emissão de NFS-e (SpeedGov)' || sqlerrm);
             --
          end;
...
-------------------------------------------------------------------------------------------------------------------------------------------
Prompt FIM - Redmine #76740 Criação de padrão speedgov - 47
-------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------
Prompt Início Redmine #76254: Criar estrutura para R2055
--------------------------------------------------------------------------------------------------------------------------------------
declare
   --
   vn_fase number := 0;
...
begin
   ...
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO           is ''Indicador de aquisição, sendo valores válidos entre 1 e 7''');
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.DM_FORMA_TRIB_CONTR_PREV   is ''Indicador da forma de contribuição previdenciária, sendo: 0=Comercialização da Produção / 1=Folha de pagamento''');
   ...
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.PERC_INSS_NR               is ''Percentual de INSS Não Retido suspenso por processo''');
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.PERC_GILRAT_NR             is ''Percentual de GILRAT Não Retido suspenso por processo''');
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.PERC_SENAR_NR              is ''Percentual de SENAR Não Retido suspenso por processo''');
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.NRO_PROC                   is ''Numero do processo''');
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.COD_SUSP_PROC              is ''Código de suspenção relacionado ao processo judicial''');
   ...
   pExec_Imed('comment on column CSF_OWN.PESSOA_AQUIS_PROD_RURAL.PROCADMEFDREINFINFTRIB_ID  is ''Código de suspenção relacionado ao processo judicial''');
   --
   vn_fase := 3;
   --
   -- Constraints --
   ...
   --
   -- Domínios --
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO','1','Pessoa física ou segurado especial em geral');
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO','2','Pessoa física ou segurado especial em geral - entidade PAA');
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO','3','Pessoa jurídica por entidade executora do PAA');
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO','4','Pessoa física ou segurado especial em geral -Produção isenta');
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO','5','Pessoa física ou segurado especial em geral - entidade PAA e Produção isenta');
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO','6','Pessoa jurídica por entidade executora do PAA e Produção isenta');
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_IND_AQUISICAO','7','Pessoa física ou segurado especial para fins de exportação');
   --
   pk_csf.pkb_cria_dominio('PESSOA_AQUIS_PROD_RURAL.DM_FORMA_TRIB_CONTR_PREV','0','Comercialização da Produção');
   ...
   --
   -- Comments --
   pExec_Imed('comment on table  CSF_OWN.AQUIS_PROD_RURAL_REINF                            is ''Tabela de Aquisição de Produção Rural para o Reinf''');
   ...
   pExec_Imed('comment on column CSF_OWN.AQUIS_PROD_RURAL_REINF.DM_ST_PROC                 is ''Dominio de Situacão: 0-Em Aberto, 1-Validado;  2-Erro de Validacão; 3-Digitado''');
   pExec_Imed('comment on column CSF_OWN.AQUIS_PROD_RURAL_REINF.DT_REF                     is ''Data de referencia''');
   pExec_Imed('comment on column CSF_OWN.AQUIS_PROD_RURAL_REINF.PESSOA_ID                  is ''ID da pessoa do produtor rural, do qual foi efetuada aquisição de produção pelo contribuinte declarante.''');
   pExec_Imed('comment on column CSF_OWN.AQUIS_PROD_RURAL_REINF.DM_FORMA_TRIB_CONTR_PREV   is ''Indicador da forma de contribuição previdenciária, sendo: 0=Comercialização da Produção / 1=Folha de pagamento''');
   pExec_Imed('comment on column CSF_OWN.AQUIS_PROD_RURAL_REINF.DM_ENVIO                   is ''Dominio indicativo de Envio da Informacão para o EFD-REINF.''');
   pExec_Imed('comment on column CSF_OWN.AQUIS_PROD_RURAL_REINF.DM_RETIFS1250              is ''Indicativo de retificação de informação enviada ao ambiente nacional do eSocial. Valores validos: "S" ou nulo''');
   --   
   vn_fase := 10;
   --
   -- Constraints --
   ...
   pk_csf.pkb_cria_dominio('AQUIS_PROD_RURAL_REINF.DM_ST_PROC','2','Erro de Validacão');
   pk_csf.pkb_cria_dominio('AQUIS_PROD_RURAL_REINF.DM_ST_PROC','3','Digitado');
   --
   pk_csf.pkb_cria_dominio('AQUIS_PROD_RURAL_REINF.DM_FORMA_TRIB_CONTR_PREV','0','Comercialização da Produção');
   pk_csf.pkb_cria_dominio('AQUIS_PROD_RURAL_REINF.DM_FORMA_TRIB_CONTR_PREV','1','Folha de pagamento');
   --
   pk_csf.pkb_cria_dominio('AQUIS_PROD_RURAL_REINF.DM_ENVIO','0','Não Enviado');
   pk_csf.pkb_cria_dominio('AQUIS_PROD_RURAL_REINF.DM_ENVIO','1','Enviado');
   --
   pk_csf.pkb_cria_dominio('AQUIS_PROD_RURAL_REINF.DM_RETIFS1250','S','Retificação enviada ao E-Social');
   --
   vn_fase := 14;
   --
   -- Grants --
   ...
   --
   -- Comments --
   pExec_Imed('comment on table  CSF_OWN.DET_AQUIS_PROD_RURAL_REINF                            is ''Tabela de Detalhamento Aquisição de Produção Rural para o Reinf''');
   ...
   pExec_Imed('comment on column CSF_OWN.DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO           is ''Indicador de aquisição, sendo valores válidos entre 1 e 7''');
   pExec_Imed('comment on column CSF_OWN.DET_AQUIS_PROD_RURAL_REINF.VL_BRUTO                   is ''Valor bruto da aquisição da produção rural''');
   ...
   pExec_Imed('comment on column CSF_OWN.DET_AQUIS_PROD_RURAL_REINF.VL_INSS_NR                 is ''Percentual de INSS Não Retido suspenso por processo''');
   pExec_Imed('comment on column CSF_OWN.DET_AQUIS_PROD_RURAL_REINF.VL_GILRAT_NR               is ''Percentual de GILRAT Não Retido suspenso por processo''');
   pExec_Imed('comment on column CSF_OWN.DET_AQUIS_PROD_RURAL_REINF.VL_SENAR_NR                is ''Percentual de SENAR Não Retido suspenso por processo''');
   ...
   pExec_Imed('comment on column CSF_OWN.DET_AQUIS_PROD_RURAL_REINF.PROCADMEFDREINFINFTRIB_ID  is ''Código de suspenção relacionado ao processo judicial''');
   --
   vn_fase := 17;
   --
   -- Constraints --
   ...
   --
   -- Domínios --
   pk_csf.pkb_cria_dominio('DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO','1','Pessoa física ou segurado especial em geral');
   pk_csf.pkb_cria_dominio('DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO','2','Pessoa física ou segurado especial em geral - entidade PAA');
   pk_csf.pkb_cria_dominio('DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO','3','Pessoa jurídica por entidade executora do PAA');
   pk_csf.pkb_cria_dominio('DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO','4','Pessoa física ou segurado especial em geral -Produção isenta');
   pk_csf.pkb_cria_dominio('DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO','5','Pessoa física ou segurado especial em geral - entidade PAA e Produção isenta');
   pk_csf.pkb_cria_dominio('DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO','6','Pessoa jurídica por entidade executora do PAA e Produção isenta');
   pk_csf.pkb_cria_dominio('DET_AQUIS_PROD_RURAL_REINF.DM_IND_AQUISICAO','7','Pessoa física ou segurado especial para fins de exportação');
   --
   vn_fase := 21;
   --
   -- Grants --
   ...
   --
   -- Comments --
   pExec_Imed('comment on table  CSF_OWN.EFD_REINF_R2055                            is ''Notas fiscais mercantil de Aquisição de produção rural''');
   ...
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R2055.DM_ST_PROC                 is ''Situação do Processo: 0-Aberto; 1-Validado; 2-Erro de Valida¿Æo; 3-Aguardando Envio; 4-Processado; 5-Erro no Envio; 6-Erro na montagem do XML; 7-Excluído, 8-Processado R-5001''');
   ...
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R2055.NRO_RECIBO                 is ''Número do Recibo do Evento Processado''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R2055.DM_IND_TP_INSCR            is ''Dominio indicador do Tipo de Inscrição: 1-CNPJ e 4-CNO.''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R2055.NRO_INSCR_ESTAB            is ''Numero de Inscrição do Estabelecimento de acordo com o tipo de inscrição indicado.''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R2055.CNPJ                       is ''CNPJ do fornecedor do Produto''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R2055.PESSOA_ID                  is ''Código identificador relacionado com a Tabela de PESSOA.''');
   ...
   pk_csf.pkb_cria_dominio('EFD_REINF_R2055.DM_ST_PROC','2','Erro de Validação');
   ...
   pk_csf.pkb_cria_dominio('EFD_REINF_R2055.DM_ST_PROC','7','Excluído');
   ...
   --
   -- Comments --
   pExec_Imed('comment on table  CSF_OWN.EFD_REINF_R5001_R2055                            is ''Informações dos eventos R-5001/R-2055''');
   ...
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.PERIODO_APUR               is ''Período de apuração''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.DM_TP_INSC                 is ''Tipo de inscrição do contribuinte: 1-CNPJ; 2-CPF''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.NRO_INSC                   is ''Número de inscrição do contribuinte''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.COD_RETORNO                is ''Código do retorno''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.DESC_RETORNO               is ''Descrição do retorono''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.NRO_PROT_ENTR              is ''Número do protocolo de entrega do evento''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.DT_PROCESSO                is ''Data e hora do início do processamento da consulta''');
   ...
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.NRO_REC_ARQ_BASE           is ''Número do arquivo que deu origem ao presente arquivo de retorno ao contribuinte''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.CNPJ_PRESTADOR             is ''CNPJ do prestador de serviços''');
   pExec_Imed('comment on column CSF_OWN.EFD_REINF_R5001_R2055.VL_TOT_BASE_RET            is ''Base de cálculo da retenção da contribuição previdenciária''');
   -- 
   vn_fase := 37;
   --
   -- Constraints --
...
--------------------------------------------------------------------------------------------------------------------------------------
Prompt Término Redmine #76254: Criar estrutura para R2055
--------------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------
Prompt INI Redmine #71633 - Ajustes para evitar erros na conciliação EPEC
-------------------------------------------------------------------------------------------------------------------------------
   ...
   begin
      insert into csf_own.dominio ( dominio
                           ...
                           values ( 'NOTA_FISCAL.DM_ST_PROC'
                                  , 9
                                  , 'Conciliação EPEC Rejeitada'
                                  , csf_own.dominio_seq.nextval);
   exception
      when others then
         update csf_own.dominio
            set descr = 'Conciliação EPEC Rejeitada'           
...
-------------------------------------------------------------------------------------------------------------------------------
Prompt FIM Redmine #71633 - Ajustes para evitar erros na conciliação EPEC
-------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------
Prompt INI - Redmine 77021	- Adicionar alteração de campo ao patch 2.9.6.3
-------------------------------------------------------------------------------------------------------------------------------
declare
   vn_existe number := null;
begin 
   select count(*)
     ...
     from all_tab_columns ac 
    where upper(ac.OWNER)       = upper('CSF_OWN')
      and upper(ac.TABLE_NAME)  = upper('CTRL_INTEGR_ARQ')
      and upper(ac.COLUMN_NAME) = upper('NRO');
   --
   if nvl(vn_existe,0) > 0 then
      --
      execute immediate 'ALTER TABLE CSF_OWN.CTRL_INTEGR_ARQ MODIFY NRO NUMBER(30)';
      --
   end if;
   --      
exception
   when others then
      raise_application_error(-20001, 'Erro no script 77021. Campo NRO. Erro: ' || sqlerrm);      
end;
/

-------------------------------------------------------------------------------------------------------------------------------
Prompt FIM - Redmine 77021	- Adicionar alteração de campo ao patch 2.9.6.3
-------------------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------------------------------------
Prompt INI - Redmine #73698 Inclusão de evento do sefaz 'Prestação de Serviço em Desacordo'
-------------------------------------------------------------------------------------------------------------------------------------------
DECLARE
vn_count INTEGER;
--
BEGIN
  ...
  BEGIN
    SELECT COUNT(1) 
          INTO vn_count
      FROM CSF_OWN.TIPO_EVENTO_SEFAZ
     WHERE CD = '610110';
  EXCEPTION
    WHEN OTHERS THEN
      vn_count := 0;
  ...
  IF vn_count <> 0 THEN 
        BEGIN
                INSERT INTO CSF_OWN.TIPO_EVENTO_SEFAZ ( id
                                                                        , cd
                                                                        , descr )    
                    VALUES ( TIPOEVENTOSEFAZ_SEQ.NEXTVAL
                           , '610110'
        ...
        EXCEPTION
                WHEN OTHERS THEN
                        raise_application_error(-20101, 'Erro no script Redmine #73698 Adicionar evento sefaz 610110.' || sqlerrm);
    END;
  ELSIF vn_count = 0 THEN
        BEGIN
                UPDATE CSF_OWN.TIPO_EVENTO_SEFAZ 
               SET descr   = 'Prestação de Serviço em Desacordo'
         WHERE cd = '610110'; 
                  --
        COMMIT; 
        --
        EXCEPTION
                WHEN OTHERS THEN
                        raise_application_error(-20102, 'Erro no script Redmine #73698 Alterar descrição do evento sefaz 610110.' || sqlerrm);
    END;
  END IF;
END;  
/
-------------------------------------------------------------------------------------------------------------------------------------------
Prompt FIM - Redmine #73698 Inclusão de evento do sefaz 'Prestação de Serviço em Desacordo'
-------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------
Prompt INI Redmine #75141 Criar novos campos na integração vw_csf_subgrupo_pat_ff
--------------------------------------------------------------------------------------------------------------------------------------
begin
  INSERT INTO CSF_OWN.FF_OBJ_UTIL_INTEGR(ID, OBJUTILINTEGR_ID, ATRIBUTO, DESCR, DM_TIPO_CAMPO, TAMANHO, QTDE_DECIMAL)
              VALUES(FFOBJUTILINTEGR_SEQ.NEXTVAL, (SELECT ID FROM OBJ_UTIL_INTEGR WHERE OBJ_NAME = 'VW_CSF_SUBGRUPO_PAT_FF'), 'COD_BC_CRED_PC', 'Código de Base de Cálculo do Crédito', 2, 2, 0);
exception when others then
  null;
end;            
/
begin
  INSERT INTO CSF_OWN.FF_OBJ_UTIL_INTEGR(ID, OBJUTILINTEGR_ID, ATRIBUTO, DESCR, DM_TIPO_CAMPO, TAMANHO, QTDE_DECIMAL)
              VALUES(FFOBJUTILINTEGR_SEQ.NEXTVAL, (SELECT ID FROM OBJ_UTIL_INTEGR WHERE OBJ_NAME = 'VW_CSF_SUBGRUPO_PAT_FF'), 'DM_IDENT_BEM_IMOB', 'Identificação dos Bens/Grupo de Bens Incorporados ao Ativo Imobilizado', 2, 2, 0);
exception when others then
  null;
end;            
/              
begin              
  INSERT INTO CSF_OWN.FF_OBJ_UTIL_INTEGR(ID, OBJUTILINTEGR_ID, ATRIBUTO, DESCR, DM_TIPO_CAMPO, TAMANHO, QTDE_DECIMAL)
              VALUES(FFOBJUTILINTEGR_SEQ.NEXTVAL, (SELECT ID FROM OBJ_UTIL_INTEGR WHERE OBJ_NAME = 'VW_CSF_SUBGRUPO_PAT_FF'), 'DM_IND_UTIL_BEM_IMOB', 'Ind Util Bens Incorp Ativo Imob: 1-Prod Bens Venda; 2-Prest de Serv; 3-Loc Terc; 9-Outros.', 1, 1, 0);
exception when others then
  null;
end;            
/              
begin              
  INSERT INTO CSF_OWN.FF_OBJ_UTIL_INTEGR(ID, OBJUTILINTEGR_ID, ATRIBUTO, DESCR, DM_TIPO_CAMPO, TAMANHO, QTDE_DECIMAL)
              VALUES(FFOBJUTILINTEGR_SEQ.NEXTVAL, (SELECT ID FROM OBJ_UTIL_INTEGR WHERE OBJ_NAME = 'VW_CSF_SUBGRUPO_PAT_FF'), 'COD_ST_PIS', 'Codigo da Situação Tributaria', 2, 3, 0);
exception when others then
  null;
end;            
/              
begin              
  INSERT INTO CSF_OWN.FF_OBJ_UTIL_INTEGR(ID, OBJUTILINTEGR_ID, ATRIBUTO, DESCR, DM_TIPO_CAMPO, TAMANHO, QTDE_DECIMAL)
              VALUES(FFOBJUTILINTEGR_SEQ.NEXTVAL, (SELECT ID FROM OBJ_UTIL_INTEGR WHERE OBJ_NAME = 'VW_CSF_SUBGRUPO_PAT_FF'), 'COD_ST_COFINS', 'Codigo da Situação Tributaria', 2, 3, 0);
exception when others then
  null;
end;            
/              
begin              
  INSERT INTO CSF_OWN.FF_OBJ_UTIL_INTEGR(ID, OBJUTILINTEGR_ID, ATRIBUTO, DESCR, DM_TIPO_CAMPO, TAMANHO, QTDE_DECIMAL)
              VALUES(FFOBJUTILINTEGR_SEQ.NEXTVAL, (SELECT ID FROM OBJ_UTIL_INTEGR WHERE OBJ_NAME = 'VW_CSF_SUBGRUPO_PAT_FF'), 'COD_CTA', 'Codigo da conta analitica/grupo de contas', 2, 255, 0);
exception when others then
  null;
end;            
/              
...
/
--------------------------------------------------------------------------------------------------------------------------------------
Prompt FIM Redmine #75141 Criar novos campos na integração vw_csf_subgrupo_pat_ff
--------------------------------------------------------------------------------------------------------------------------------------

-------------------------------------------------------------------------------------------------------------------------------
Prompt INI Redmine #77187 - CK DA TABELA ABERTURA_GIA INCORRETA
-------------------------------------------------------------------------------------------------------------------------------
--wendel 
declare 
 vn_existe number := 0;
begin
  begin
    ...
    select count(1)
      into vn_existe
      from CSF_OWN.dominio d
    where upper(D.DOMINIO) = upper('ABERTURA_GIA.DM_SITUACAO')
      and d.vl             = '6'
      and upper(d.descr)   = upper('REGISTROS GERADOS');
    --
  exception
    when others then
      vn_existe := 0;
  ...
  if nvl(vn_existe,0) = 0 then 
    ...
    begin
        insert into CSF_OWN.DOMINIO ( dominio
                                     ...
                                     ,descr
                                     ,id  )    
                             values ( 'ABERTURA_GIA.DM_SITUACAO'
                                     ,'6'
                                     ,'Registros Gerados'
                                     ,CSF_OWN.DOMINIO_SEQ.NEXTVAL); 
        --
     ...
     exception
       when others then
         raise_application_error(-20101, 'Erro ao inserir dominio ABERTURA_GIA.DM_SITUACAO com valor 6 (Registros Gerados ) - ' || sqlerrm);
     end;
     --
  end if;
  --
  begin
    begin
      execute immediate 'ALTER TABLE CSF_OWN.ABERTURA_GIA DROP CONSTRAINT ABERTURAGIA_SITUACAO_CK';
    exception
     when others then
       raise_application_error(-20101, 'Erro ao excluir CONSTRAINT ABERTURAGIA_SITUACAO_CK - ' || sqlerrm);
    end;
    --
    begin
      execute immediate 'alter table CSF_OWN.ABERTURA_GIA add constraint ABERTURAGIA_SITUACAO_CK check (dm_situacao in (0, 1, 2, 3, 4, 5, 6)) ';
    exception
     when others then
       raise_application_error(-20101, 'Erro ao inserir CONSTRAINT ABERTURAGIA_SITUACAO_CK - ' || sqlerrm);
    end;
    --
    begin
      execute immediate 'comment on column CSF_OWN.ABERTURA_GIA.dm_situacao is ''Situação: 0-Não Gerado / 1-Erro de validação / 2-Validado / 3-Gerado Arquivo / 4-Erro na geração do arquivo / 5-Em Geração / 6-Registros Gerados'' ';
    exception
     when others then
       raise_application_error(-20101, 'Erro ao inserir comentario ABERTURA_GIA.DM_SITUACAO - ' || sqlerrm);
    end;
  end;
  --
end;
/
--------------------------------------------------------------------------------------------------------------------------------------
Prompt FIM Redmine #77187 - CK DA TABELA ABERTURA_GIA INCORRETA
-------------------------------------------------------------------------------------------------------------------------------
